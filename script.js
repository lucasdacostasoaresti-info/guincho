...
(function () {
    ...
    function setActive(target) {
        logos.forEach(function (logo) {
            var isOver = target ? logo.contains(target) : false;
            logo.classList.toggle("is-active", isOver);
        });
    }
    ...
    // Mostra o "Home" assim que o dedo toca ou desliza sobre a logo
    document.addEventListener("touchstart", handleTouch, { passive: true });
    document.addEventListener("touchmove", handleTouch, { passive: true });

    // Esconde novamente quando o dedo sai da tela
